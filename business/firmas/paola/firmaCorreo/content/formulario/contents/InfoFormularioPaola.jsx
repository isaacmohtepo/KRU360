...
import FirmaPaola from "../../firmaPaola/components/firmaPaola";

export default class InfoFormularioPaola extends React.Component {
    state = {
        nombre: "Paola Cortés",
        cargo: "CEO",
        pagina: "",
    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <FirmaPaola name={nombre} position={cargo} sizeNombre={sizeNombre} sizeCargo={sizeCargo}/>
            </div>
